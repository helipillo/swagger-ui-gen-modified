...
<head>
    ...
    <link href="https://swaggerui.herokuapp.com/css/index.css" rel="stylesheet"/>
    <link href='https://swaggerui.herokuapp.com/css/standalone.css' rel='stylesheet'/>
    <link href='https://swaggerui.herokuapp.com/css/api-explorer.css' rel='stylesheet' type='text/css'/>
    <link href='https://swaggerui.herokuapp.com/css/screen.css' media='screen' rel='stylesheet' type='text/css'/>

    <script src='https://swaggerui.herokuapp.com/lib/jquery-1.8.0.min.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/jquery.slideto.min.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/jquery.wiggle.min.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/jquery.ba-bbq.min.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/handlebars-2.0.0.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/underscore-min.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/backbone-min.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/swagger-ui.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/jsoneditor.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/highlight.7.3.pack.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/marked.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/swagger-oauth.js' type='text/javascript'></script>
    <script src='https://swaggerui.herokuapp.com/lib/bootstrap.min.js' type='text/javascript'></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if (url && url.length > 1) {
                ...
                url = window.location.toString().replace(/\/*#?.*/, '/swagger-spec.json');
            }
